    ...
    return (
        <div className='my-5 '>
            <div className='relative'>
                <img
                    className='lg:h-96 md:h-48  h-32 w-full rounded-2xl'
                    src={banner} alt="" />
                <div className='absolute inset-0 flex flex-col justify-center items-center text-center text-white bg-black/40 rounded-2xl px-4 space-y-2'>
