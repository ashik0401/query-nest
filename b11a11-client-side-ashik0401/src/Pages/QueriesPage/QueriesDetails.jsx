...
const QueriesDetails = () => {
    ...
    useEffect(() => {
        fetch(`https://query-nest-two.vercel.app/queries/${id}`)
            .then(res => res.json())
            .then(data => setQuery(data));

        fetch(`https://query-nest-two.vercel.app/recommendations/${id}`)
            .then(res => res.json())
    ...
    const handleSubmit = async e => {
        ...
        await fetch('https://query-nest-two.vercel.app/recommendations', {
            method: 'POST',
