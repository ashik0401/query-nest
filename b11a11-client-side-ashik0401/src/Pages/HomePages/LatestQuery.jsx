...
const LatestQuery = () => {
    ...
    useEffect(() => {
        fetch('https://query-nest-two.vercel.app/queries')
            .then(res => res.json())
    ...
    return (
        <div className='mt-15'>
            <h2 className='md:text-4xl text-2xl font-bold Cursive text-primary text-center md:text-start mb-5'>🕘 Latest Queries </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-2 transition-transform">
                {queries.map((query) => (
                    <div key={query._id} className="card bg-base-100 h-[600px] sm:h-[680px] md:h-[500px] lg:h-[600px] overflow-hidden shadow-sm hover:shadow-lg hover:-translate-y-3 transform transition-all duration-300">
                        ...
                        <div className="card-body p-4">
                            ...
                            <div className="flex justify-between items-center mt-4">
                                <div className="badge bg-base-300 text-white text-xs py-4 px-3">
