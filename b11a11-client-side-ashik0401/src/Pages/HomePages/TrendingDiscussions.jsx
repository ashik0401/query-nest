        ...
        <section className="py-16 bg-gradient-to-b from-white to-gray-50">
            <div className="max-w-7xl mx-auto md:px-4">
                <motion.h2
                    ...
                    className="md:text-4xl text-xl font-bold text-center mb-12 Cursive text-primary"
                >
                    ...
                    <div className="grid gap-6 md:grid-cols-3 sm:grid-cols-2 grid-cols-1">
                        {queries.map((query, index) => (
                            <motion.div
                                ...
                                className="group border bg-white shadow-md rounded-xl p-6 transition duration-300 h-full flex flex-col justify-between"
                            >
